...
export type ChordQuality = 
  ...
  | 'dim' | 'dim7' | 'm7b5' | 'aug' | 'sus2' | 'sus4' | '6' | 'm6'
  | '9' | 'maj9' | 'm9' | 'add9' | 'add11' | 'add#11' | 'add13' | 'add#13'
  | '+5' | 'maj7+5' | '7+5' | 'm11' | '13' | 'm13'
  | 'omit5' | 'm(omit5)' | '7omit5' | 'maj7omit5' | 'm7omit5' | 'omit3' | '5'
  | '7omit3' | 'sus2omit5' | 'sus4omit5' | '7sus4omit5' | '9omit5' | 'm9omit5';
